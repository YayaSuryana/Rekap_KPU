...
class DprpController extends Controller
{
    ...
    public function index()
    {
        ...
        $des = request('desa');
        $tps = request('tps');
        $collection = Dprp::report()->get();

        $partai = Dprp::select('partai', DB::raw('SUM(total) AS total_suara_partai'))
        ...
        ->toArray();
            ...
            $tpsVal = Dprp::select('tps', DB::raw('SUM(total) AS total_suara_tps'))
            ...
            $desaVal = Dprp::select('desa', DB::raw('SUM(total) AS total_suara_desa'))
            ...
            $kecamatanVal = Dprp::select('kecamatan', DB::raw('SUM(total) AS total_suara_kecamatan'))
            ...
            $kabupatenVal = Dprp::select('kabupaten', DB::raw('SUM(total) AS total_suara_kabupaten'))
